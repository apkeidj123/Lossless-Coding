/************************** Start of AHUFF.C *****************************
 *
 *    This is the adaptive Huffman coding module introduced in Chapter 5.
...
char *AHCompressionName = "Adaptive Huffman coding, with escape codes";
...
void AHCompressFile( FILE *input, BIT_FILE *output, int argc, char *argv[] );
void AHExpandFile( BIT_FILE *input, FILE *output, int argc, char *argv[] );
