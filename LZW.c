...
char *LWCompressionName = "LZW 12 Bit Encoder";
...
void LWCompressFile( FILE *input, BIT_FILE *output, int argc, char *argv[] )
{
    int next_code;
    int character;
    int string_code;
 ...
 */
void LWExpandFile( BIT_FILE *input, FILE *output, int argc,char *argv[] )
{
